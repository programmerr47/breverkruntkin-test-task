package cleverpumpkintesttask.programmerr47.github.com.flightsviewer.representation.view;
...
/**
 * Copied from https://github.com/nirhart/ParallaxScroll
 *
...
public class ParallaxScrollView extends ScrollView {
    ...
    protected void init(Context context, AttributeSet attrs) {
        TypedArray typeArray = context.obtainStyledAttributes(attrs, R.styleable.ParallaxScrollView);
        this.parallaxFactor = typeArray.getFloat(R.styleable.ParallaxScrollView_parallax_factor, DEFAULT_PARALLAX_FACTOR);
        this.alphaFactor = typeArray.getFloat(R.styleable.ParallaxScrollView_alpha_factor, DEFAULT_ALPHA_FACTOR);
        this.innerParallaxFactor = typeArray.getFloat(R.styleable.ParallaxScrollView_inner_parallax_factor, DEFAULT_INNER_PARALLAX_FACTOR);
        this.numOfParallaxViews = typeArray.getInt(R.styleable.ParallaxScrollView_parallax_views_num, DEFAULT_PARALLAX_VIEWS);
        typeArray.recycle();
    }
